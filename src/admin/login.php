...
<html lang="en">
  <head>
    ...
    <title>Admin Login | <?php echo $settingsData['wbsiteTitle'];?></title>
  </head>
  <body>
      ...
      <div class="col-lg-6 mb-5 mb-lg-4 position-relative">
        ...
        <div class="card bg-glass">
          <div class="card-body px-4 py-5 px-md-5">
            <h5 class="card-title text-center pb-2">Admin Login | <?php echo $settingsData['wbsiteTitle'];?></h5>
            ...
            <form action="login-code.php" method="POST">
              ...
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingInput" name="username" placeholder="Username" value="" required>
                <label for="floatingInput">Username</label>
              </div>
              <div class="form-floating mb-3">
                <input type="password" class="form-control" id="floatingPassword" name="password" placeholder="Password" value="" required>
