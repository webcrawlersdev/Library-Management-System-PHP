...
?>
<title>Request Logs | <?php echo $settingsData['wbsiteTitle'];?></title>

<div class="container-fluid px-4">
    <h1 class="mt-4">Request Logs</h1>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body table-responsive">
                    ...
                    <table id="reqLogsTable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Student ID</th>
                                <th>ISBN</th>
